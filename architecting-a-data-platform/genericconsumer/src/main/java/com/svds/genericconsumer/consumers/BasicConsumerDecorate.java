 ...
 */
public class BasicConsumerDecorate extends Consumer {
    
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(BasicConsumerDecorate.class);
    
    public BasicConsumerDecorate() {
    ...
    public void run() {
        ...
        while (it.hasNext()) {
            ...
            System.out.println("CONSUMER: " + message + "-" + System.currentTimeMillis());
